...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Successfully subtract credits from a user\'s account")]
        [Xunit.TraitAttribute("FeatureTitle", "translation credits")]
        [Xunit.TraitAttribute("Description", "Successfully subtract credits from a user\'s account")]
        public void SuccessfullySubtractCreditsFromAUsersAccount()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Successfully subtract credits from a user\'s account", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 21
  this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
...
#line hidden
#line 24
    testRunner.When("I send a POST request to /users/{id}/credits/subtract", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 25
    testRunner.Then("I get an OK response", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
